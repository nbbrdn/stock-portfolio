...
def test_validate_stock_data_nominal():
    ...
    """
    stok_data = StockModel(
        stock_symbol='SBUX',
        number_of_shares='100',
        purchase_price='45.67',
    )
    assert stok_data.stock_symbol == 'SBUX'
    assert stok_data.number_of_shares == 100
    assert stok_data.purchase_price == 45.67
...
def test_validate_stock_data_invalid_purchase_price():
    """
    GIVEN a helper class to validatethe form data
